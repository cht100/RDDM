...
def parse_args():
    parser = argparse.ArgumentParser(description="RDDM x4 super-resolution test.")
    parser.add_argument("--train-gt-flist", default="data/DIV2K_x4_sr/flists/train_gt.flist")
    parser.add_argument("--train-input-flist", default="data/DIV2K_x4_sr/flists/train_input.flist")
    parser.add_argument("--test-gt-flist", default="data/DIV2K_x4_sr/flists/test_gt.flist")
    parser.add_argument("--test-input-flist", default="data/DIV2K_x4_sr/flists/test_input.flist")
    parser.add_argument("--results-folder", default="./results/sr_x4")
    parser.add_argument("--output-folder", default="./results/sr_x4_test")
