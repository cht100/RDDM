...
def parse_args():
    parser = argparse.ArgumentParser(description="RDDM color Gaussian denoising test.")
    ...
    parser.add_argument("--output-folder", default="./results/denoising_sigma25_color_test")
